...
for fold, (tr_idx, val_idx) in enumerate(kf.split(X_train, y_train), 1):
    ...
    # libera memoria GPU tra un fold e l'altro
...
print(f"\n[OK] Risultati {PATIENT_ID} — EpiDeNet CNN:")
...
csv_path = RESULTS_DIR / f"{PATIENT_ID}_cnn_results.csv"
with open(csv_path, 'w', newline='') as f:
    ...
    writer.writeheader()
    writer.writerow({
        "model": "EpiDeNet_CNN", "patient": PATIENT_ID,
